...
const fields: Field[] = [
  ...
  { name: "section_title_zh", label: "Título da seção em chinês" },
  { name: "section_subtitle", label: "Subtítulo", textarea: true },
  { name: "section_subtitle_zh", label: "Subtítulo em chinês", textarea: true },
  { name: "full_text", label: "Texto completo", textarea: true },
  { name: "full_text_zh", label: "Texto completo em chinês", textarea: true },
  { name: "mission", label: "Missao", textarea: true },
  { name: "mission_zh", label: "Missao em chinês", textarea: true },
  { name: "vision", label: "Visao", textarea: true },
  { name: "vision_zh", label: "Visao em chinês", textarea: true },
  { name: "values", label: "Valores", textarea: true },
  { name: "differentials", label: "Diferenciais", textarea: true },
  { name: "differentials_zh", label: "Diferenciais em chinês", textarea: true },
  { name: "stat_20", label: "20+" },
  { name: "stat_20_zh", label: "20+ em chinês" },
  { name: "stat_35", label: "35+" },
  { name: "stat_35_zh", label: "35+ em chinês" },
  { name: "stat_500", label: "500+" },
  { name: "stat_500_zh", label: "500+ em chinês" },
  { name: "stat_100", label: "100%" },
  { name: "stat_100_zh", label: "100% em chinês" },
...
export default function CompanyContentPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      full_text_zh: form.full_text_zh,
      mission: form.mission,
      mission_zh: form.mission_zh,
      vision: form.vision,
      vision_zh: form.vision_zh,
      values: form.values,
      differentials: form.differentials,
      differentials_zh: form.differentials_zh,
      stat_20: form.stat_20,
      stat_20_zh: form.stat_20_zh,
      stat_35: form.stat_35,
      stat_35_zh: form.stat_35_zh,
      stat_500: form.stat_500,
      stat_500_zh: form.stat_500_zh,
      stat_100: form.stat_100,
      stat_100_zh: form.stat_100_zh,
